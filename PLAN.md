...
- [ ] 원장 후속: public/base-currency whole-portfolio·performance valuation, historical FX와 표시/통화별 rounding 정책, provider FX/price ingestion·source priority·calendar 정책, FX/거래·분할·기업행사 정정, 배당 재투자·국가별 세금 분류와 credentialed broker 체결/현금 reconciliation
