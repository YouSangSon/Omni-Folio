...
- G4H passes credential-free complete snapshot validation, atomic raw snapshot plus ledger-revision reconciliation idempotency, quantity diff, last-known-good retention, insert-only ledger/broker rows and backup v3 broker-state recovery. No credential, actual broker request, scheduler, authoritative freshness, public route/UI or auto-correction was added.
