...
- 2026-08-27 `flutter analyze` and 36 tests pass. Overview, asset-detail, import-preview and atomic-apply failures replace upstream exception text with context-specific recovery copy; regression fixtures prove account/provider details are absent, and import failures are announced as a live region.
