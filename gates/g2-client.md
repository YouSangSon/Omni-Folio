...
- 2026-08-26 `flutter analyze` and 23 tests pass. G4K adds strict stored-reconciliation parsing, fixed-route/404 handling, loading/empty/error/retry/success UI, exact quantity text, color-independent status, row semantics and retained-known-good behavior after refresh failure.
