...
- 2026-08-24 `flutter analyze` and 10 tests pass, including malformed financial JSON fail-closed, retained/retry error state, atomic apply receipt, preview invalidation, a 320×480 surface at 200% text, semantic headings and trust detail, labeled 44pt/48dp targets, light/dark text contrast, and reduced-motion static loading/zero-duration navigation.
- Release builds pass for web, iOS without codesigning (`Runner.app`, 16.2 MB), and Android (`app-release.apk`, 49.4 MB).
