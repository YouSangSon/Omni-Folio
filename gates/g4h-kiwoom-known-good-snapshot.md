...
- `TestG4HBackupRestoresBrokerSnapshotProof`는 현재 schema v5/backup v4 broker digest/count, restored projection, manifest tampering과 약한 trigger rejection을 검증한다.
