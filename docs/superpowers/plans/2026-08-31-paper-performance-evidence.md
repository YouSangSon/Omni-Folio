...
- [ ] **Step 1: Write domain examples first**
...
- [ ] **Step 3: Refactor replay once, then derive marks**
...
- Modify: `contracts/fixtures/backup-manifest.json`
...
- [ ] **Step 1: Write failing persistence, concurrency, corruption, schema, backup, and legacy tests**
...
- [ ] **Step 4: Implement one transactional use case and recovery**
...
- [ ] **Step 5: Extend the existing backup proof in the same GREEN change**
...
- [ ] **Step 1: Run focused GREEN and root verification**
...
- [ ] **Step 2: Audit owned resource cleanup**
...
- [ ] **Step 3: Record factual evidence and commit**
