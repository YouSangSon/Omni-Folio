...
- **Native holding valuation**: G1.13의 internal `native_holding_valuation_v1` read model. replay-verified 현재 보유자산을 원통화 시장가·미실현손익·통화별 합계로만 계산하며, local fixture와 24시간 정책 때문에 current/live authority가 아니다.
