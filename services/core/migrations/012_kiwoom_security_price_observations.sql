DROP TRIGGER security_price_observations_no_update;
DROP TRIGGER security_price_observations_no_delete;
DROP INDEX security_price_observations_latest_idx;

ALTER TABLE security_price_observations RENAME TO security_price_observations_v11;

CREATE TABLE security_price_observations (
    sequence INTEGER PRIMARY KEY,
    observation_id TEXT NOT NULL UNIQUE,
    source TEXT NOT NULL CHECK (source IN ('local_fixture', 'kiwoom_mock', 'kiwoom_production')),
...
INSERT INTO security_price_observations(
    sequence,observation_id,source,source_observation_id,instrument_id,symbol,venue,currency,price,price_adjustment,observed_at,fetched_at,record_sha256,recorded_at
)
SELECT sequence,observation_id,source,source_observation_id,instrument_id,symbol,venue,currency,price,price_adjustment,observed_at,fetched_at,record_sha256,recorded_at
FROM security_price_observations_v11;

DROP TABLE security_price_observations_v11;
