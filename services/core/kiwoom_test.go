...
func TestKiwoomRejectsMockNXTAndNonReadAPIIDsBeforeNetwork(t *testing.T) {
	...
	for _, allowed := range []string{"ka00001", "kt00018", "ka10075", "kt00009", "ka10079", "ka10080", "ka10081"} {
		if !kiwoomReadAPIAllowed(allowed) {
			t.Fatalf("read API %s is missing from the closed allowlist", allowed)
		}
	}
	if kiwoomReadPath("kt00009") != kiwoomAccountPath || kiwoomReadPath("ka10079") != kiwoomChartPath || kiwoomReadPath("ka10080") != kiwoomChartPath || kiwoomReadPath("ka10081") != kiwoomChartPath || kiwoomReadPath("kt10000") != "" {
